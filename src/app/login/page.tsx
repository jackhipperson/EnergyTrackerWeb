    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-md p-8 flex flex-col gap-5">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900">EnergyTracker</h1>
          <p className="text-sm text-gray-500 mt-1">Track your electricity &amp; gas costs</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-green-600 text-white rounded-xl px-4 py-2.5 text-sm font-medium hover:bg-green-700 disabled:opacity-50 transition-colors"
          >
        ...
        <p className="text-center text-xs text-gray-400">
          ...
          <button onClick={switchMode} className="text-green-600 hover:underline font-medium">
